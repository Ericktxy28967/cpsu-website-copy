...
<body class="font-poppins bg-[#000000]">
        ...
        <div class="w-full h-auto flex flex-col justify-center items-center text-center gap-2 p-1 py-10 bg-[#fafafa]">
            <span class="flex items-center justify-center text-center gap-2 p-2 pb-5 pt-5">
                    <img src="../assets/images/leaves_one.png" alt="leaves_one" class="w-[88px] h-[75px] max-sm:w-[60px] h-[40px]">
                        <span class="border-b-4 border-b-[#656363] flex flex-col items-center justify-center text-center pb-2 max-sm:px-1 px-5 leading-none">
                            ...
                            <span class="text-[32px] max-md:text-[25px] text-[#656363] font-medium tracking-widest">FACULTY & STAFF</span>
                        </span>
                    <img src="../assets/images/leaves.png" alt="leaves_two" class="w-[88px] h-[75px] max-sm:w-[60px] h-[40px]">
             </span>

             <span class="text-[20px] tracking-widest font-bold">COLLEGE OF TEACHERS EDUCATION</span>
             <span class="flex flex-col items-center justify-center text-center p-2 pt-4 gap-2">
                <img src="../assets/images/user.png" alt="user_image" class="w-[122px] h-[120px] object-cover object-center rounded-full border-8 border-green-900 shadow-[0px_0px_50px_rgba(16,70,24,0.9)]">
                <span class="flex flex-col pt-3">
                    <span class="font-bold">ALADINO C. MORACA, Ph.D</span>
                    <span class="text-green-800">CPSU President</span>
                    <span class="text-[13px] italic">Admin & Academic Council Chairman Board of Regents Vice Chair</span>
                </span>
             </span>
             <span class="flex flex-wrap gap-5 pt-3 items-center justify-center">
                <span class="flex flex-col items-center justify-center text-center p-2 gap-2">
                <img src="../assets/images/user.png" alt="user_image" class="w-[122px] h-[120px] object-cover object-center rounded-full border-8 border-green-900 shadow-[0px_0px_50px_rgba(16,70,24,0.9)]">
                <span class="flex flex-col pt-3">
                    <span class="font-bold">ALADINO C. MORACA, Ph.D</span>
                    <span class="text-green-800">CPSU President</span>
             ...
             <span class="text-[20px] tracking-widest font-bold pt-10">COLLEGE OF COMPUTER STUDIES</span>
             <span class="flex flex-col items-center justify-center text-center p-2 pt-4 gap-2">
                <img src="../assets/images/user.png" alt="user_image" class="w-[122px] h-[120px] object-cover object-center rounded-full border-8 border-green-900 shadow-[0px_0px_50px_rgba(16,70,24,0.9)]">
                <span class="flex flex-col pt-3">
                    <span class="font-bold">ALADINO C. MORACA, Ph.D</span>
             ...
             <span class="text-[20px] tracking-widest font-bold pt-10">COLLEGE OF AGRICULTURE</span>
             <span class="flex flex-col items-center justify-center text-center p-2 pt-4 gap-2">
                <img src="../assets/images/user.png" alt="user_image" class="w-[122px] h-[120px] object-cover object-center rounded-full border-8 border-green-900 shadow-[0px_0px_50px_rgba(16,70,24,0.9)]">
                <span class="flex flex-col pt-3">
                    <span class="font-bold">ALADINO C. MORACA, Ph.D</span>
