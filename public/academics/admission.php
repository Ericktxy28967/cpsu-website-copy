...
<head>
    ...
    <link rel="shortcut icon" href="../assets/images/CPSU_logo.png" type="image/x-icon">
...
<body class="font-poppins bg-[#000000]">
        ...
        <span class="w-auto flex items-center gap-5 max-md:gap-3">
         ...
         <a href="/cpsu-moises-website/admin/index.php" target="blank" class="outline-none flex items-center justify-center text-center gap-2 pointer pl-5 max-md:pl-3 border-l pointer border-l-[#FCFCFC]">
        ...
        <div class="w-full h-auto flex justify-evenly items-center text-center bg-[#104618] text-[#fafafa] p-2 gap-10">
            <span class="flex items-center justify-center text-center gap-2">
                <img src="../assets/images/CPSU_logo.png" alt="CPSU Logo" class="w-[50pxpx] h-[49.73px]">
            ...
            <span class="max-md:hidden flex flex-wrap items-center justify-center text-center gap-1 p-1">
                <a href="https://ched.gov.ph/" target="blank"><img src="../assets/images/CHED.png" alt="ched_logo" class="w-[35px] h-[35px] pointer"></a>
                <a href="https://www.foi.gov.ph/" target="blank"><img src="../assets/images/FOI.webp" alt="foi_logo" class="w-[35px] h-[35px] rounded-full pointer"></a>
                <img src="../assets//images/CCS.png" alt="css_logo" class="w-[39px] h-[37px] pointer">
                <img src="../assets//images/logo-coted.png" alt="coted_logo" class="w-[42px] h-[42px] pointer">
                <img src="../assets//images/BSAB.png" alt="bsab_logo" class="w-[44px] h-[42px] pointer">
            </span>
        </div>
                ...
                <div class="w-full h-auto flex justify-center items-center text-center bg-[#FFFFFF] gap-10 text-[#474747] p-4">
                    <ul class="max-md:hidden flex items-center justify-center text-center gap-10 text-[16px] font-bold text-[16px]">
                        ...
                        <div class="absolute left-0 z-20 hidden group-hover:block bg-white border shadow-md mt-0 rounded-lg">
                            <ul class="w-48 py-2">
                            <li><a href="./program-offers.php" class="block px-4 py-2 hover:bg-green-900 hover:text-white">Program Offers</a></li>
                            <li><a href="./admission.php" class="block px-4 py-2 hover:bg-green-900 hover:text-white">Admission</a></li>
                            </ul>
                        </div>
                        </div>
                        <div class="relative group">
                            ...
                            <ul class="flex flex-col gap-5 pt-10 max-md:pt-1 font-[500] text-[15px] text-[#000000]">
                                ...
                                <li class="bg-white text-green-900 hover:bg-green-900 hover:text-white p-2 rounded-[12px]">
                                  ...
                                  <div class="relative inline-block text-center items-center justify-center">
                                    ...
                                    <a href="./program-offers.php" class="block px-4 py-2 text-gray-700 hover:text-white hover:bg-green-900">Program Offers</a>
        ...
        <div class="w-full h-auto flex flex-col bg-white py-10 justify-center items-center p-1 bg-[#fafafa]">
            <span class="flex w-full h-auto items-center justify-evenly p-3">
                    <span class="flex flex-col border-l-4 border-green-900 p-3">
                        <span class="text-[24px] text-green-900 max-sm:text-[18px] font-semibold tracking-widest">ADMISSION</span>
                        <span class="text-[16px] text-[#757272] max-sm:text-[12px] font-medium tracking-wide">Check the admission and medical requirements</span>
                    </span>
                    <span></span>
                    <span></span>
            </span>
            <span class="w-[70%] max-sm:w-auto h-auto p-3">
                <span>Admission pertains to the system of assessing and evaluating students who may qualify to be admitted at Central Philippines State University. The goals and objectives of the admission process are: to screen prospective students both in the undergraduate and graduate levels for possible placement on the different courses offered by the university and to assist incoming students in their choice of course within the State College at the same time assess the students' potential for higher education based on the specialization of the State College (technological, agricultural, education, etc.)</span>
            </span>
            <span class="pt-10">ADMISSION REQUIREMENTS</span>
            <div class="w-full h-auto flex flex-wrap justify-center gap-5 items-center p-1 py-5">
                <span class="w-[500px] h-auto flex flex-col p-2">
