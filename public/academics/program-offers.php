...
<body class="font-poppins bg-[#000000]">
                            ...
                            <ul class="flex flex-col gap-5 pt-10 max-md:pt-1 font-[500] text-[15px] text-[#000000]">
                                ...
                                <li class="bg-white text-green-900 hover:bg-green-900 hover:text-white p-2 rounded-[12px]">
                                  ...
                                  <div class="relative inline-block text-center items-center justify-center">
                                    ...
                                    <a href="./admission.php" class="block px-4 py-2 text-gray-700 hover:text-white hover:bg-green-900">Admission</a>
                                    </div>
                                </div>
                                    <div class="relative inline-block text-center items-center justify-center">
        ...
        <div class="w-full h-auto items-center justify-center bg-white p-1 py-10 bg-[#fafafa]">
            <span class="flex items-center justify-center text-center gap-2 p-2 pb-5 pt-5">
                        ...
                        <span class="border-b-4 border-b-[#656363] flex flex-col items-center justify-center text-center pb-2 max-sm:px-1 px-5 leading-none">
                            ...
                            <span class="text-[32px] max-md:text-[25px] text-[#656363] font-medium tracking-widest">PRORAM OFFERS</span>
                        </span>
             ...
             <div class="w-full h-auto py-10">
                <span class="flex w-full h-auto items-center justify-evenly p-3">
                    <span class="flex flex-col border-l-4 border-green-900 p-3">
                        <span class="text-[24px] text-green-900 max-sm:text-[18px] font-semibold tracking-widest">Central Philippines State University Moises Padilla Campus</span>
                        <span class="text-[16px] text-[#757272] max-sm:text-[12px] font-medium tracking-wide">History of Central Philippines State University - Moises Padilla Campus</span>
                    </span>
                    <span></span>
                    <span></span>
               </span>
               <span class="flex w-full h-auto items-center justify-evenly p-3">
                    <span class="text-[20px] max-sm:text-[15px] font-semibold text-green-900">
                        <li>BS on Teacher Education</li>
